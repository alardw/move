...
const STRATEGIES: {
...
}[] = [
  {
    mode: 'end',
    title: 'End',
    blurb: 'The default — trims the tail and adds an ellipsis. Right for most labels and values.',
  },
  {
    mode: 'start',
    title: 'Start',
    blurb: 'Keeps the end in view. Handy when the part that matters is at the end.',
  },
  {
    mode: 'middle',
    title: 'Middle',
    blurb: 'Keeps both ends and hides the middle. Made for file paths, IDs, and hashes.',
  },
  {
    mode: 'clamp',
    title: 'Clamp',
    blurb: 'Wraps to a set number of lines, then ellipsizes. For blurbs and descriptions.',
  },
];
            ...
            >
              <div style={{ maxWidth: 360, width: '100%' }}>
                <Stack direction="row" gap="sm" align="center">
                  <Stack flex={1}>
                    <Text truncate>feature/a-really-long-branch-name-that-overflows-the-row</Text>
                  </Stack>
                  <Badge variant="soft">Draft</Badge>
                </Stack>
              </div>
