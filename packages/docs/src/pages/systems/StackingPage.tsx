      ...
      <Stack gap="xl" flex={1}>
        ...
        >
          <Stack gap="md">
            ...
            <Stack gap="sm">
              <Heading level={3}>Don't write raw z-index in component CSS</Heading>
              <Text>
                Always reference the token: <Code>z-index: var(--move-z-popover);</Code>. The
                numeric values are tuned and may shift on schema bumps; a hard-coded number stops
                tracking the layer system.
              </Text>
            </Stack>
          </Stack>
        </Section>
