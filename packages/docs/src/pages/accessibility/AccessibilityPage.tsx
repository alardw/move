...
const PERCEIVABLE: Criterion[] = [
  ...
  { sc: '1.4.8', name: 'Visual Presentation', level: 'AAA', support: 'supports', note: { included: 'Prose caps the text column to ~68ch (--move-prose-measure, under the 80-char limit), sets line-height 1.625 with 1.6em paragraph spacing, and never justifies text; resize/reflow to 200% comes from 1.4.4 / 1.4.10.', yours: 'User-selectable foreground/background colours come from the browser/app (a theme switcher).' } },
