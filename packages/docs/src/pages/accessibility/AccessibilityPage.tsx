...
const PERCEIVABLE: Criterion[] = [
  ...
  { sc: '1.4.8', name: 'Visual Presentation', level: 'AAA', support: 'partial', note: { included: 'Prose sets line-height 1.625 (≥1.5), never justifies text, and resizes/reflows to 200% without horizontal scroll (1.4.4 / 1.4.10).', gap: 'Prose does not cap line length to ~80 characters (width is 100%), and paragraph spacing (1em) is below the 1.5×-line-height target.', yours: 'User-selectable foreground/background colours are app-level.' } },
