...
const PERCEIVABLE: Criterion[] = [
  ...
  { sc: '1.4.6', name: 'Contrast (Enhanced)', level: 'AAA', support: 'partial', note: { included: 'Body text runs 14–17:1, and links and most secondary text clear the 7:1 AAA bar in the stock themes.', gap: 'The subtle tier is held at ~4.5:1 (AA) by design — a deliberately recessive third text level. Lifting it to 7:1 would collapse the base/muted/subtle hierarchy, so it stays AA on purpose.' } },
