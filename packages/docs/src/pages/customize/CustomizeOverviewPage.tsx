...
const PICK_A_THEME: HighlightItem[] = [
  {
    ...
    text: (
      <>
        Give the <RouterLink to="/customize/theme">theme builder</RouterLink> a neutral and an
        accent color and it builds the whole thing for you — every surface, text tier, border, and
  ...
  },
  {
    ...
    text: (
      <>
        Already have a design system — Tailwind, Figma, Material? Bring it in: its accent, gray,
        corner radius, and fonts go into the seed, and Move reproduces the rest. See the{' '}
...
const SECTIONS: HighlightItem[] = [
  {
    ...
    text: (
      <>
        <RouterLink to="/customize/typography">Typography</RouterLink> — set your font with one
  ...
  },
  {
    ...
    text: (
      <>
        <RouterLink to="/customize/internationalization">Internationalization</RouterLink> —
      ...
      <Stack gap="xl" flex={1}>
        ...
        <Stack gap="sm">
          ...
          <Text color="muted" size="lg">
            Move looks good out of the box — and it’s yours to shape. Pick your colors and let Move
            build the theme, choose your fonts, bring your own icons, and speak your users’
            language. It’s all tokens and props, so your changes stay tidy instead of scattered
            across the codebase.
          </Text>
        ...
        <Section id="sections" title="In this section" lede="The rest of the toolkit.">
          <Stack gap="md">
            <HighlightList items={SECTIONS} />
            <Text color="muted">
              How the visual system works underneath — the{' '}
              <RouterLink to="/core-concepts/theming-model">token model</RouterLink> in Core
              Concepts, plus <RouterLink to="/systems/surfaces">surfaces</RouterLink> and{' '}
              <RouterLink to="/systems/stacking">stacking</RouterLink> under Systems.
            </Text>
          </Stack>
        </Section>
      </Stack>
