...
const READERS: HighlightItem[] = [
  ...
  {
    icon: 'shield-check',
    text: 'The validators check that the code still matches what the spec promised.',
  },
  {
    icon: 'book-open',
    text: 'The docs you’re reading render their prop and token tables straight from it.',
  },
      ...
      <Stack gap="xl" flex={1}>
        ...
        <Stack gap="sm">
          ...
          <Text color="muted" size="lg">
            Everything in Move — a component, a composite, a design pattern — is described by a
            typed spec: a plain, complete account of what it is. That one file is the contract, and
            it’s the thing the whole system agrees on.
          </Text>
        ...
        >
          <Text>
            Conformance is the enforcement half. A set of checks compares each spec against the
            source it describes — the props, the slots, the default values, the tokens — and fails
            the build the moment they drift apart. So the docs, the generators, and the assistant
            can trust the spec is still true without anyone re-verifying it by hand. It’s the
        ...
        >
          <Text>
            ...
            <RouterLink to="/contracts/conformance">Conformance</RouterLink> model that enforces
            them.
          </Text>
        </Section>
      </Stack>
