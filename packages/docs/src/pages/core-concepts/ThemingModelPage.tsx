...
const THE_MODEL: HighlightItem[] = [
  {
    ...
    text: (
      <>
        ...
        <RouterLink to="/customize/theme">defineThemes</RouterLink> a neutral and an accent color
        and it writes every token for you — surfaces, text, borders, states — in light and dark at
        once.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        ...
        <RouterLink to="/customize/theme#import">Import it</RouterLink> — distill a Tailwind, Radix,
        Material, or Figma token set down to a seed and Move regenerates the matching light + dark
        theme, contrast still guaranteed. An AI assistant can do the distilling for you.
      </>
    ),
  },
  {
...
const SUB_TOPICS: HighlightItem[] = [
  {
    ...
    text: (
      <>
        <RouterLink to="/customize/typography">Typography</RouterLink> — set the font with one
        token, plus the size and weight scale.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        <RouterLink to="/systems/surfaces">Surfaces</RouterLink> — bg-base, bg-subtle, bg-muted,
        bg-emphasis, and when to reach for each.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        <RouterLink to="/systems/stacking">Stacking</RouterLink> — the z-layer system for modals,
        popovers, and toasts.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        <RouterLink to="/customize/icons">Icons</RouterLink> — bring your own icon library through
        one resolver.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        <RouterLink to="/systems/hooks">useTheme</RouterLink> — read the active theme and swap it at
        runtime from anywhere in the app.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        <RouterLink to="/ai/skills">AI theming</RouterLink> — hand the whole job to an assistant:
        generate a brand theme, or import an existing one, with the app-theme skill.
      </>
    ),
  },
  {
      ...
      <Stack gap="xl" flex={1}>
        ...
        <Stack gap="sm">
          ...
          <Text color="muted" size="lg">
            Everything you can see — color, spacing, radius, type — comes from one set of tokens.
            Hand Move a couple of colors and it generates the whole theme; reach into any single
            token when you want to fine-tune.
          </Text>
