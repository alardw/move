...
function Preview({
  ...
  useEffect(() => {
    ...
    const proxy = { v: 0 };
    const sampler = animate(proxy, { v: [0, 1], ease: easeVal, duration: dur } as Parameters<
      typeof animate
    >[1]);
    sampler.pause();
        ...
        <Card.Body>
          <Stack gap="lg">
            <Stack direction="row" align="center" gap="md">
              <Text size="sm" color="muted" className={styles.rowLabel}>
                Position
              </Text>
          ...
          <Stack gap="xs" align="center">
            ...
            <div className={styles.plot}>
              ...
              >
                ...
                <text className={styles.axis} x={MARGIN - 8} y={PLOT - MARGIN + 4} textAnchor="end">
                  0
                </text>
                <text className={styles.axis} x={MARGIN - 8} y={MARGIN + 4} textAnchor="end">
                  1
                </text>
                <text
        ...
        <Grid minChildWidth="200px" gap="lg">
          <Stack gap="xs">
            ...
            <InputRange
              ...
              step={0.1}
              value={params.mass}
              onValueChange={(v: number[]) => update('mass', v[0])}
              showValue
            />
          </Stack>
          <Stack gap="xs">
            ...
            <InputRange
              ...
              onValueChange={(v: number[]) => update('stiffness', v[0])}
              showValue
            />
          </Stack>
          <Stack gap="xs">
            ...
            <InputRange
              ...
              onValueChange={(v: number[]) => update('damping', v[0])}
              showValue
            />
          </Stack>
          <Stack gap="xs">
            ...
            <InputRange
              ...
              onValueChange={(v: number[]) => update('velocity', v[0])}
              showValue
            />
          </Stack>
        </Grid>
