  ...
  return (
    <Stack gap="lg">
      <Stack gap="xs">
        ...
        <InputRange aria-label="Duration (ms)" min={200} max={3000} step={100} value={duration} onValueChange={(v: number[]) => setDuration(v[0])} showValue />
      </Stack>
      ...
      <Stack gap="xs">
        ...
        <Grid minChildWidth="200px" gap="lg">
          <Stack gap="xs">
            ...
            <InputRange aria-label="Mass" min={0.1} max={10} step={0.1} value={params.mass} onValueChange={(v: number[]) => update('mass', v[0])} showValue />
          </Stack>
          <Stack gap="xs">
            <Text size="sm" color="muted">Stiffness</Text>
            <InputRange aria-label="Stiffness" min={10} max={1000} step={10} value={params.stiffness} onValueChange={(v: number[]) => update('stiffness', v[0])} showValue />
          </Stack>
          <Stack gap="xs">
            <Text size="sm" color="muted">Damping</Text>
            <InputRange aria-label="Damping" min={1} max={100} step={1} value={params.damping} onValueChange={(v: number[]) => update('damping', v[0])} showValue />
          </Stack>
          <Stack gap="xs">
            <Text size="sm" color="muted">Velocity</Text>
            <InputRange aria-label="Velocity" min={0} max={10} step={0.5} value={params.velocity} onValueChange={(v: number[]) => update('velocity', v[0])} showValue />
          </Stack>
        </Grid>
      </Stack>
