...
const events = [
  { title: 'Pushed v2.4.3 to staging', when: '2 minutes ago', color: 'success' as const, body: 'Tagged from main, ran the regression suite, deployed to the staging cluster.' },
  ...
  { title: 'Triage bug from #ingest', when: '3 hours ago', color: 'warning' as const, body: 'Webhook timing out on staging when the queue is hot. Repro in progress.' },
];
