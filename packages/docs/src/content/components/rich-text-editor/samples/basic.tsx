  ...
  return (
    <RichTextEditor.Root>
      ...
      <RichTextEditor.Content>
        {/* composite-purity-ignore: editor body content is authored as raw HTML — that's the editor's purpose */}
        <p>
          {/* composite-purity-ignore, dogfood-ignore: editor body content is authored as raw HTML — that's the editor's purpose */}
          Type here. Try <strong>Cmd+B</strong> for bold, <strong>Cmd+I</strong> for italic, or use
          the toolbar above.
        </p>
      </RichTextEditor.Content>
    </RichTextEditor.Root>
