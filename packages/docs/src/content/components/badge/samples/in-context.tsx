    ...
    <Stack gap="md">
      ...
      <Card.Root>
        <Card.Header>
          <Stack direction="row" gap="sm" align="center">
            ...
            <Badge variant="soft" color="warning">Maintenance</Badge>
          </Stack>
      ...
      <Card.Root>
        <Card.Header>
          ...
          <Card.Description>Job has been retrying for 2 hours — paged the data team.</Card.Description>
        </Card.Header>
      </Card.Root>
      <Stack direction="row" gap="sm" align="center">
        <Text>Tags:</Text>
        <Badge variant="surface" color="indigo">design</Badge>
        <Badge variant="surface" color="teal">accessibility</Badge>
        <Badge variant="surface" color="orange">performance</Badge>
      </Stack>
    </Stack>
  );
}
