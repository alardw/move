      ...
      {variants.map((v) => (
        <Stack key={v} gap="xs">
          ...
          <Stack direction="row" gap="sm" align="center" wrap>
            ...
            <Badge variant={v} color="success">Active</Badge>
            <Badge variant={v} color="warning">Trial</Badge>
            <Badge variant={v} color="danger">Past due</Badge>
            <Badge variant={v} color="info">Beta</Badge>
          </Stack>
        </Stack>
      ))}
    </Stack>
