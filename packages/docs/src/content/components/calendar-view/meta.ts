...
const related: RelatedItem[] = [
  {
    ...
    name: 'Calendar',
    reason:
      'For picking one or more dates inline. CalendarView is for showing what’s already on a schedule.',
  },
  {
...
export const meta: ComponentDocument = {
  ...
  name: 'CalendarView',
  tagline:
    'A full month/week/day/agenda calendar with a real time grid, events that span days, an all-day row, and built-in controls for navigation and view switching.',
  ...
  keyboard: [
    {
      key: 'Tab',
      action: 'Moves focus between the navigation buttons, view switcher, and event tiles.',
    },
