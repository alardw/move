...
const related: RelatedItem[] = [
  {
    ...
    name: 'VideoPlayer',
    reason:
      'Same control language and keyboard contract, with a video surface and full-screen support.',
  },
  {
    to: '/components/slider',
    name: 'Slider',
    reason:
      'For generic value-on-a-track controls — volume bars, brightness, opacity. AudioPlayer’s scrubber is purpose-built and not exposed standalone.',
  },
];
...
export const meta: ComponentDocument = {
  ...
  name: 'AudioPlayer',
  tagline:
    'A horizontal audio bar with everything you’d expect — play, scrub, volume, speed, subtitles, source switching. Keyboard works the way you’d hope.',
  categories: ['media'],
  ...
  keyboard: [
    ...
    {
      key: 'Tab',
      action: 'Moves focus through the controls (play, scrubber, volume, settings, subtitles).',
    },
  ],
  accessibilityLede:
