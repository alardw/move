...
const personas = [
  {
    ...
    color: 'pink' as const,
    message: 'Bumped the spacing tokens by one step — the headers were swallowing the body copy.',
  },
  {
    name: 'Theo (Engineering)',
    initials: 'TP',
    src: 'https://i.pravatar.cc/96?img=33',
    color: 'indigo' as const,
    message: 'Picked up the reduced-motion guard — should land in the next prerelease.',
  },
  {
    name: 'Jamie (Support)',
    initials: 'JC',
    ...
    color: 'teal' as const,
    message: 'Two customers asked about RTL today — adding to the FAQ for Friday.',
  },
  {
    name: 'Auto-deploy',
    initials: 'AD',
    ...
    message: 'Deployed v2.4.3 to production. 124 new sessions in the last hour.',
  },
];
