...
const variants = [
  {
    ...
    text: 'The default — quiet enough for long threads where the message is the focus.',
  },
  {
    ...
    text: 'Brand-tinted — for your own messages, or replies you want to emphasise.',
  },
  {
    ...
    text: 'Confirmations, completions, "task done" responses.',
  },
  {
    ...
    text: 'Soft yellow — heads-up messages, rate-limit notices, mild errors.',
  },
  {
    ...
    text: 'Red — failures, blocked actions, and anything the user must read.',
  },
];
