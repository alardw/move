    ...
    <Stack gap="md">
      <ChatBubble.Root placement="start">
        ...
        <ChatBubble.Container tail>
          ...
          <ChatBubble.Content>
            Hey — I left the new theme tokens on the design branch. Want me to walk you through
            them?
          </ChatBubble.Content>
      ...
      <ChatBubble.Root placement="end">
        ...
        <ChatBubble.Container variant="primary" tail>
          <ChatBubble.Content>
            Yes please — I’m about to override the primary palette and don’t want to do it twice.
          </ChatBubble.Content>
          <ChatBubble.Footer>just now</ChatBubble.Footer>
        </ChatBubble.Container>
      </ChatBubble.Root>
