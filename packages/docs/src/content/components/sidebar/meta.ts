...
const related: RelatedItem[] = [
  {
    ...
    name: 'Drawer',
    reason:
      'Use when the panel is transient — file pickers, detail views, settings flows that close after the user is done.',
  },
  {
    to: '/components/tabs',
    name: 'Tabs',
...
export const meta: ComponentDocument = {
  ...
  name: 'Sidebar',
  tagline:
    'A collapsible navigation aside that does the right thing on every screen — full labels on desktop, icons-only when collapsed, an overlay sheet on mobile.',
