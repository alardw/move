...
const related: RelatedItem[] = [
  {
    ...
    name: 'Avatar',
    reason:
      'For profile pictures with a circular crop and fallback initials. Image is the rectangular general-purpose version.',
  },
  {
    to: '/components/grid',
    name: 'Grid',
    reason:
      'For galleries: `<Grid stagger>` with `Image` children (use `backdrop` to fill mixed aspect ratios).',
  },
];
...
export const meta: ComponentDocument = {
  ...
  name: 'Image',
  tagline:
    'A wrapped image with aspect ratio, object-fit, radius, fallback, a blurred backdrop fill, and an overlay slot.',
  categories: ['media'],
  badges: [],
  highlights,
  related,
  ...
  keyboard: [
    ...
    {
      key: 'Enter / Space',
      action: 'Activates the image — same as a click. Only when `interactive` is set.',
    },
  ],
  accessibilityLede:
