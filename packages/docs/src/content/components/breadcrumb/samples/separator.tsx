    ...
    <Stack gap="md">
      <Stack gap="xs">
        ...
        <Breadcrumb>
          ...
          <Breadcrumb.Item>
            <Breadcrumb.Link href="/team">Team</Breadcrumb.Link>
          </Breadcrumb.Item>
          <Breadcrumb.Item>
            <Breadcrumb.Page>Permissions</Breadcrumb.Page>
          </Breadcrumb.Item>
        </Breadcrumb>
      </Stack>
      <Stack gap="xs">
        ...
        <Breadcrumb separator="/">
          ...
          <Breadcrumb.Item>
            <Breadcrumb.Page>Marketing site</Breadcrumb.Page>
          </Breadcrumb.Item>
        </Breadcrumb>
      </Stack>
      <Stack gap="xs">
        ...
        <Breadcrumb separator={<Icon name="chevrons-right" />}>
          ...
          <Breadcrumb.Item>
            <Breadcrumb.Page>Audio</Breadcrumb.Page>
          </Breadcrumb.Item>
        </Breadcrumb>
      </Stack>
    </Stack>
