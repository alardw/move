            ...
            <Stack gap="md">
              <Stack direction="row" gap="md" align="center">
                ...
                <Stack gap="none">
                  ...
                  <Text size="sm" color="muted">Senior product designer · she/her</Text>
                  <Stack direction="row" gap="xs" align="center">
                    <Badge variant="dot" color="success">Available</Badge>
                  </Stack>
                </Stack>
              </Stack>
              <Divider gap="xs" />
              <Stack gap="xs">
                ...
                <Text>
                  Designs the systems team’s component library, runs the weekly design crit, and writes the
                  Friday digest nobody reads but everyone misses when it’s gone.
                </Text>
              </Stack>
              <Divider gap="xs" />
              <Stack gap="xs">
                <Text size="sm" color="muted">Recent work</Text>
