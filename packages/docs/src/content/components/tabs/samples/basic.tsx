    ...
    <Tabs.Root defaultValue="overview">
      ...
      <Tabs.Content value="overview">
        <Stack gap="sm" padding="md">
          ...
          <Text size="sm" color="muted">
            High-level summary of this project — recent activity, open issues, owners.
          </Text>
        </Stack>
      </Tabs.Content>
      <Tabs.Content value="activity">
        <Stack gap="sm" padding="md">
          ...
          <Text size="sm" color="muted">
            A timeline of pushes, comments, and merges.
          </Text>
        </Stack>
      </Tabs.Content>
      <Tabs.Content value="settings">
        <Stack gap="sm" padding="md">
          ...
          <Text size="sm" color="muted">
            Permissions, integrations, and webhook URLs.
          </Text>
        </Stack>
      </Tabs.Content>
    </Tabs.Root>
