...
import { CompositionContractPage } from './pages/core-concepts/CompositionContractPage';
          ...
          <ScrollArea.Content ref={contentRef}>
            <Stack padding="2xl">
              ...
              <Routes>
                ...
                <Route path="/core-concepts/composition-contract" element={<CompositionContractPage />} />
