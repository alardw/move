...
description: "Run full generation pipeline for a Move component: source, test, docs, validate. Requires spec."
user-invocable: true
...
### Step 2 — `/component-generate-test {Name}`
Generates `.test.tsx` from the spec and component source.

### Step 3 — `/component-generate-docs {Name}`
