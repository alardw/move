---
name: app-feature
description: "Generate a complete feature spanning multiple pages, composites, and routing. Orchestrates all artifacts."
user-invocable: true
---
...
Read `references/app/feature-patterns.md` for feature decomposition strategy, cross-page state patterns, and routing conventions.
...
- Pages → follow `app-page` patterns
- Composites → follow `app-composite` patterns
