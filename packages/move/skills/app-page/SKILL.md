---
name: app-page
description: "Generate a page component for a route, composed from Move components. No custom CSS allowed."
user-invocable: true
---
...
Read `references/app/page-patterns.md` for page structure conventions.
