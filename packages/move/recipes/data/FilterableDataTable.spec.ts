...
export const spec = {
  ...
  composition: ['Table', 'Stack', 'InputText', 'Button', 'Text', 'Badge', 'Pagination', 'Icon', 'Dialog', 'Checkbox', 'FormField'],
  behaviors: [
  ...
  integrationPoints: [
    {
      ...
      shape: [
        ...
        { name: 'role', type: 'enum', note: 'Role column / filter facet.', sortable: true, filterable: true },
        { name: 'email', type: 'string', note: 'Email column.', searchable: true, sortable: true },
        { name: 'status', type: 'enum', note: 'Status badge column / filter facet.', sortable: true, filterable: true, render: 'badge' },
      ],
    },
    {
      id: 'filterOptions',
  ...
  labels: [
    ...
    { key: 'showing', default: 'Showing {from}–{to} of {total}', description: 'Result-count summary.', params: ['from', 'to', 'total'] },
  ],
  preview: { width: 'full' },
