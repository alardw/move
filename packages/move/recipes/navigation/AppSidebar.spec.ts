...
export const spec = {
  ...
  composition: ['Sidebar', 'useSidebarContext', 'Avatar', 'Icon', 'Text', 'Stack', 'Tooltip', 'Dropdown', 'Button', 'Badge'],
  behaviors: [
  ...
  integrationPoints: [
    { id: 'navItems', kind: 'data', description: 'Provide the real nav items (replaces SAMPLE_NAV_ITEMS).' },
    { id: 'onNavigate', kind: 'handler', description: 'Handle nav item selection / routing and active-route detection.' },
    { id: 'account', kind: 'data', description: 'Provide the real user — name, role, avatar (replaces the sample account).' },
    { id: 'onSignOut', kind: 'handler', description: 'Sign the user out from the account dropdown.' },
  ],
  labels: [
    { key: 'appName', default: 'Acme', description: 'Product name in the header.' },
    { key: 'collapse', default: 'Collapse sidebar', description: 'Collapse control tooltip/label.' },
