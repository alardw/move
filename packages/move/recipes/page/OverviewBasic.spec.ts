...
export const spec = {
  ...
  composition: ['Stack', 'Grid', 'Card', 'Heading', 'Text', 'Badge', 'Button', 'Icon', 'Avatar', 'List', 'Table'],
  behaviors: [
  ...
  integrationPoints: [
    ...
    { id: 'activities', kind: 'data', description: 'Provide the real activity feed (replaces SAMPLE_ACTIVITIES).' },
    { id: 'performers', kind: 'data', description: 'Provide the real top performers (replaces SAMPLE_PERFORMERS).' },
