...
export const spec = {
  ...
  composition: ['Stack', 'Heading', 'Text', 'Splitter', 'ScrollArea', 'List', 'Badge', 'Button', 'Divider', 'Icon', 'Avatar'],
  behaviors: [
  ...
  integrationPoints: [
    { id: 'messages', kind: 'data', description: 'Provide the real messages (replaces SAMPLE_MESSAGES).' },
  ...
  labels: [
    ...
    { key: 'selectMessageDescription', default: 'Choose a conversation from the list to view its contents.', description: 'Empty-detail description.' },
