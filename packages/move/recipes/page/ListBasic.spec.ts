...
export const spec = {
  ...
  composition: ['Stack', 'Heading', 'Text', 'Card', 'Table', 'Badge', 'Button', 'InputText', 'Pagination', 'EmptyState', 'Icon', 'Avatar', 'usePagination'],
  behaviors: [
  ...
  integrationPoints: [
    { id: 'data', kind: 'data', description: 'Provide the real users to display (replaces SAMPLE_USERS).' },
    { id: 'onAddUser', kind: 'handler', description: 'Handle the add-user action.' },
  ],
  labels: [
    { key: 'title', default: 'Users', description: 'Page title.' },
    { key: 'description', default: 'Manage your team members and their roles.', description: 'Page description.' },
    ...
    { key: 'emptyDescription', default: 'Try adjusting your search or add a new user.', description: 'Empty-state description.' },
  ],
  preview: { width: 'full' },
