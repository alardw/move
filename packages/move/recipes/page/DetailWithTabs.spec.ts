...
export const spec = {
  ...
  composition: ['Stack', 'Heading', 'Text', 'Card', 'Badge', 'Breadcrumb', 'Button', 'Tabs', 'List', 'Timeline', 'Icon', 'Avatar', 'Table'],
  behaviors: [
  ...
  integrationPoints: [
    { id: 'entity', kind: 'data', description: 'Provide the real entity — name, status, description, detail fields (replaces the sample entity).' },
    { id: 'activity', kind: 'data', description: 'Provide the real activity entries (replaces SAMPLE_ACTIVITY).' },
    { id: 'related', kind: 'data', description: 'Provide the real related items (replaces SAMPLE_RELATED).' },
  ...
  labels: [
    ...
    { key: 'description', default: 'Complete redesign of the marketing website with new brand guidelines.', description: 'Entity description.' },
