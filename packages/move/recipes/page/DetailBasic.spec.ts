...
export const spec = {
  ...
  composition: ['Stack', 'Heading', 'Text', 'Card', 'Badge', 'Breadcrumb', 'Button', 'List', 'Icon', 'Grid', 'Avatar', 'Accordion', 'Table'],
  behaviors: [
  ...
  integrationPoints: [
    { id: 'entity', kind: 'data', description: 'Provide the real entity — name, role, detail fields (replaces the sample entity).' },
    { id: 'team', kind: 'data', description: 'Provide the real team members (replaces SAMPLE_TEAM).' },
    { id: 'integrations', kind: 'data', description: 'Provide the real integrations (replaces SAMPLE_INTEGRATIONS).' },
    { id: 'activity', kind: 'data', description: 'Provide the real activity log (replaces SAMPLE_ACTIVITY).' },
  ...
  labels: [
    ...
    { key: 'notesContent', default: 'Leads the frontend platform team. Primary contact for design system adoption. Joined from Google where she led the Material Design web components team.', description: 'Notes body.' },
    ...
    { key: 'integrationsTitle', default: 'Integrations', description: 'Integrations accordion title.' },
