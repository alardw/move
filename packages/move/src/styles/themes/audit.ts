...
const CONTRACT: Rule[] = [
  ...
  // Status at text weight: a field message or a status line is small text and
  // answers to 4.5, where the fill it used to borrow answers to 3.
  { fg: '--move-error-text', on: SURFACES, floor: 4.5, label: 'error text (field message)' },
  { fg: '--move-success-text', on: SURFACES, floor: 4.5, label: 'success text' },
  { fg: '--move-warning-text', on: SURFACES, floor: 4.5, label: 'warning text' },
  { fg: '--move-info-text', on: SURFACES, floor: 4.5, label: 'info text' },
  {
