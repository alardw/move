...
export type ComponentMeta = {
  ...
  controlled: {
    ...
    /** Custom value prop name when pattern is "value" (default: "value") */
    valueProp?: string;
    /** Custom default value prop name */
    defaultValueProp?: string;
    /** Custom onChange prop name */
    onChangeProp?: string;
  };
  ...
  constraints?: {
    ...
    /**
     * True if the component supports Radix `asChild` prop.
     */
