...
export const spec = {
  ...
  props: [
    ...
    { name: 'playLabel', type: 'string', moveSpecific: true, description: 'i18n label for play button' },
    { name: 'pauseLabel', type: 'string', moveSpecific: true, description: 'i18n label for pause button' },
    { name: 'muteLabel', type: 'string', moveSpecific: true, description: 'i18n label for mute button' },
    { name: 'unmuteLabel', type: 'string', moveSpecific: true, description: 'i18n label for unmute button' },
    { name: 'fullscreenLabel', type: 'string', moveSpecific: true, description: 'i18n label for fullscreen button' },
    { name: 'exitFullscreenLabel', type: 'string', moveSpecific: true, description: 'i18n label for exit fullscreen button' },
    ...
    { name: 'subtitlesOffLabel', type: 'string', moveSpecific: true, description: 'i18n label for "Off" option in subtitle menu' },
