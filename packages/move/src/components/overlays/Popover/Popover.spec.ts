...
export const spec = {
  ...
  subComponents: [
    {
      ...
      props: [
        {
          ...
          moveSpecific: false,
          description: 'Popover sub-components',
        },
        {
          name: 'open',
          type: 'boolean',
      ...
      usesFactory: false,
      description:
        'Stateful root that manages open/close state, animation context, and closeOnScroll option',
    },
    {
      name: 'Trigger',
      slots: [
    ...
    },
    {
      ...
      description:
        'Alternative positioning reference element (popover positions relative to this instead of trigger)',
    },
    {
      name: 'Content',
      slots: [
      ...
      description:
        'Positioned popup panel with scale/opacity animation and Radix-provided transform-origin',
    },
    {
      name: 'Arrow',
      slots: [
        { name: 'arrow', element: 'RadixPopover.Arrow', typography: 'none', description: 'Arrow SVG' },
      ],
      props: [
        { name: 'className', type: 'string', moveSpecific: false, description: 'CSS class name' },
        {
    ...
    {
      name: 'Close',
      slots: [{ name: 'close', element: 'button', typography: 'none', description: 'Close button' }],
      props: [
        { name: 'className', type: 'string', moveSpecific: false, description: 'CSS class name' },
        {
          name: 'style',
        ...
        },
        {
          ...
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Close button content (defaults to X icon)',
        },
        {
          name: 'asChild',
          type: 'boolean',
        ...
        {
          name: 'labels',
          type: 'Partial<PopoverLabels>',
          moveSpecific: true,
          description: 'Override default accessible labels',
        },
      ],
      usesFactory: true,
      radixPrimitive: 'Popover.Close',
      description:
        'Button that triggers animated close via context; renders X icon by default or custom children',
    },
  ],
  ...
  anatomy: {
    ...
    children: [{ slot: 'arrow' }, { slot: 'close' }],
  },
  ...
  renderContracts: [
    ...
    },
    {
      id: 'close-after-exit',
      description:
        'Close triggers isClosing state; Content exit animation calls onCloseComplete which unmounts the popover',
    },
    {
    ...
    },
    {
      id: 'close-on-scroll',
      description:
        'When closeOnScroll is true, Content listens for scroll events on window (capture) and triggers close()',
    },
    {
      id: 'radix-transform-origin',
      description:
        'Content uses var(--radix-popover-content-transform-origin) for position-aware animation origin',
    },
    {
      id: 'close-default-icon',
      description:
        'Close renders X icon via useResolvedIcon when no children provided; supports asChild for custom close elements',
    },
    {
      id: 'close-accessible-label',
      description: 'Close button has aria-label from labels.close (defaults to "Close")',
    },
    {
