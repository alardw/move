...
export const spec = {
  ...
  tokens: [
    ...
    { name: '--move-accordion-trigger-bg', value: 'var(--move-bg-muted)', description: 'Trigger background' },
    { name: '--move-accordion-trigger-bg-hover', value: 'var(--move-bg-emphasis)', description: 'Trigger hover background' },
    ...
    { name: '--move-accordion-content-bg', value: 'var(--move-bg-base)', description: 'Content background' },
