  ...
  subComponents: [
    {
      ...
      slots: [
        {
          ...
          kind: 'surface',
          typography: 'ui',
          description: 'Outer accordion container',
        },
      ],
      props: [
        {
      ...
      usesFactory: true,
      description:
        'Root container providing accordion context (value state, animation config) to child items',
    },
    {
      name: 'Item',
      slots: [
      ...
      props: [
        ...
        },
        {
          ...
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Header and content elements',
        },
      ],
      usesFactory: true,
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: 'AnimationTrigger[] | false',
          moveSpecific: true,
          description: 'Hover animation config for the trigger or false to disable',
        },
        {
          name: 'children',
          type: 'React.ReactNode',
      ...
      usesFactory: true,
      description:
        'Button that toggles the parent item, with hover animation and rotating chevron icon',
    },
    {
      name: 'Content',
      slots: [
  ...
  renderContracts: [
    {
      id: 'context-provider',
      description:
        'Root wraps children in AccordionContext.Provider to share state and animation config with items',
    },
    {
      id: 'item-context',
      description:
    ...
    },
    {
      ...
      description:
        'Content only renders when item is active or animating out (unmounts when fully closed)',
    },
    {
    ...
    {
      id: 'trigger-hover-animation',
      description:
        'Trigger has a subtle scale-up on hover via anime.js, configurable or disableable',
    },
    {
      id: 'keyboard-navigation',
      description:
        'Arrow Up/Down cycles focus among triggers; Home/End jump to first/last; Enter/Space toggles the focused item',
    },
    {
      id: 'single-multiple-mode',
      description:
        'In single mode, only one item can be open at a time; in multiple mode, any combination of items can be open',
    },
    {
      id: 'collapsible-single',
      description:
        'When collapsible=true (default) in single mode, clicking the open item closes it; when false, one item must always remain open',
    },
    {
      id: 'resolved-icon-chevron',
      description:
        'Trigger uses useResolvedIcon to render a default chevron-down icon when no custom icon is provided',
    },
  ],

  tokens: [
    {
      name: '--move-accordion-radius',
    ...
    {
      name: '--move-accordion-header-height',
      value: 'var(--move-space-12)',
      description: 'Minimum header height',
    },
    {
      name: '--move-accordion-trigger-padding-x',
      value: 'var(--move-spacing-md)',
      description: 'Trigger horizontal padding',
    },
    {
      name: '--move-accordion-trigger-padding-y',
      value: 'var(--move-spacing-md)',
    ...
    {
      name: '--move-accordion-trigger-fg',
      value: 'var(--move-fg-base)',
      description: 'Trigger foreground',
    },
    {
      name: '--move-accordion-trigger-border',
      value: 'var(--move-border-base)',
      description: 'Trigger border color',
    },
    {
      name: '--move-accordion-trigger-font-size',
      value: 'var(--move-size-sm)',
      description: 'Trigger font size',
    },
    {
      name: '--move-accordion-trigger-font-weight',
      value: 'var(--move-weight-medium)',
      description: 'Trigger font weight',
    },
    {
      name: '--move-accordion-content-padding',
      value: 'var(--move-spacing-md)',
    ...
    {
      name: '--move-accordion-content-font-size',
      value: 'var(--move-size-sm)',
      description: 'Content font size',
    },
    {
      name: '--move-accordion-icon-size',
      value: 'var(--move-text-xl)',
      description: 'Icon dimensions',
    },
    {
      name: '--move-accordion-icon-color',
      value: 'var(--move-fg-muted)',
      description: 'Icon color',
    },
    {
      name: '--move-accordion-transition-duration',
      value: 'var(--move-transition-normal)',
      description: 'CSS transition duration for background hover',
    },
    {
      name: '--move-accordion-transition-easing',
      value: 'var(--move-ease-default)',
      description: 'CSS transition easing for background hover',
    },
  ],
