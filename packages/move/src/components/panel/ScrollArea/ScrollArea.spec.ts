...
export const spec = {
  ...
  rootElement: 'div',
  slots: [
    { name: 'root', element: 'div', description: 'Outer flex column container that defines scroll area dimensions' },
    { name: 'header', element: 'div', description: 'Optional sticky header above scrollable content' },
    { name: 'content', element: 'div', description: 'Scrollable content area with custom scrollbar styling' },
    { name: 'footer', element: 'div', description: 'Optional sticky footer below scrollable content' },
  ],
  ...
  subComponents: [
    ...
    },
    {
      ...
      props: [
        ...
        { name: 'className', type: 'string', moveSpecific: false, description: 'CSS class name' },
        { name: 'style', type: 'React.CSSProperties', moveSpecific: false, description: 'Inline styles' },
        { name: 'padded', type: 'boolean', default: 'true', moveSpecific: true, description: 'Whether to apply padding using the scroll area padding token' },
      ],
      usesFactory: true,
    ...
    },
    {
      ...
      props: [
        { name: 'children', type: 'React.ReactNode', moveSpecific: false, description: 'Scrollable content' },
        { name: 'className', type: 'string', moveSpecific: false, description: 'CSS class name' },
        { name: 'style', type: 'React.CSSProperties', moveSpecific: false, description: 'Inline styles' },
        { name: 'padded', type: 'boolean', default: 'false', moveSpecific: true, description: 'Whether to apply padding using the scroll area padding token' },
      ],
      usesFactory: true,
      description: 'Scrollable flex-1 area with custom scrollbar styling via CSS and webkit pseudo-elements',
    },
    {
      name: 'Footer',
  ...
  renderContracts: [
    { id: 'padded-via-data-attr', description: 'Each sub-component (Header, Content, Footer) sets data-padded attribute which CSS uses to conditionally apply padding.' },
    { id: 'content-overflow-scroll', description: 'Content uses overflow-y: auto and overflow-x: hidden with custom scrollbar styling via scrollbar-width: thin and webkit pseudo-elements.' },
    { id: 'header-footer-flex-shrink', description: 'Header and Footer have flex-shrink: 0 to remain fixed while Content (flex: 1) scrolls.' },
    { id: 'scrollbar-hover-emphasis', description: 'Webkit scrollbar thumb uses --move-border-emphasis on hover for visual feedback.' },
  ],
  ...
  tokens: [
    ...
    { name: '--move-scrollarea-scrollbar-track', value: 'var(--move-scrollbar-track)', description: 'Scrollbar track color' },
    { name: '--move-scrollarea-scrollbar-radius', value: 'var(--move-rounded-full)', description: 'Scrollbar thumb/track border radius' },
  ],
