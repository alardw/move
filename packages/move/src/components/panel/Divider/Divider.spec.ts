...
export const spec = {
  ...
  rootElement: 'div',
  slots: [
    { name: 'root', element: 'div', description: 'Separator element with CSS pseudo-element lines' },
    { name: 'content', element: 'span', description: 'Optional inline label/content between the separator lines' },
  ],
  ...
  anatomy: {
    slot: 'root',
    dataAttributes: ['data-orientation', 'data-type', 'data-size', 'data-has-content', 'data-align'],
  ...
  renderContracts: [
    { id: 'content-conditional', description: 'Content slot only renders when children are provided' },
    { id: 'has-content-data-attr', description: 'data-has-content and data-align are only set on root when children are provided' },
    { id: 'pseudo-element-lines', description: 'Separator lines are rendered via CSS ::before and ::after pseudo-elements on root, not as DOM nodes' },
    { id: 'single-line-no-content', description: 'When no content is provided, ::after is hidden so only a single line renders' },
    { id: 'vertical-padding-override', description: 'In vertical orientation, content padding switches from horizontal to vertical' },
  ],

  tokens: [
    { name: '--move-divider-color', value: 'var(--move-border-base)', description: 'Line color' },
    { name: '--move-divider-size', value: '1px', description: 'Line thickness (overridden per size)' },
    { name: '--move-divider-margin', value: 'var(--move-spacing-md) 0', description: 'Outer margin' },
