...
export const spec = {
  ...
  tokens: [
    ...
    { name: '--move-list-divider-color', value: 'var(--move-border-base)', description: 'Divider line color between items' },
    { name: '--move-list-hover-bg', value: 'var(--move-surface-hover)', description: 'Background color on item hover (when hover enabled)' },
    { name: '--move-list-active-bg', value: 'var(--move-selected-bg)', description: 'Background color for active/selected items' },
    ...
    { name: '--move-list-radius', value: 'var(--move-rounded-sm)', description: 'Border radius for hover/active highlight' },
  ],
