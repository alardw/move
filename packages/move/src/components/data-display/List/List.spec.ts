...
export const spec = {
  ...
  subComponents: [
    {
      ...
      slots: [
        {
          ...
          kind: 'surface',
          typography: 'none',
          description: 'Root list container',
        },
      ],
      props: [
        {
          ...
          default: "'md'",
          moveSpecific: true,
          description: 'Controls padding, font size, gap, and avatar sizing rhythm',
        },
        {
          name: 'dividers',
          type: 'boolean',
        ...
        },
        {
          ...
          default: "'default'",
          moveSpecific: true,
          description: 'Vertical padding scale for items',
        },
        {
          name: 'hover',
          type: 'boolean',
          default: 'false',
          moveSpecific: true,
          description: 'Enable hover highlight on items',
        },
        {
          name: 'radius',
          typeRef: 'Radius',
          ...
          moveSpecific: true,
          description:
            'Border radius applied to the list container and item hover/active highlights',
        },
        {
          name: 'separator',
          type: 'React.ReactNode',
          moveSpecific: true,
          description: 'Custom separator rendered between items (replaces the default divider).',
        },
        {
          name: 'animateKey',
          type: 'string | number',
        ...
        },
        {
          ...
          moveSpecific: true,
          description: 'Staggered entrance animation config or false to disable',
        },
        {
          name: 'children',
          type: 'React.ReactNode',
      ...
      usesFactory: true,
      description:
        'Root list container providing context for size, density, hover, separator, and stagger animation',
    },
    {
      name: 'Item',
      slots: [
      ...
      props: [
        {
          ...
          default: "'li'",
          moveSpecific: true,
          description: 'Rendered element — use a/button for interactive rows',
        },
        {
          name: 'href',
          type: 'string',
          moveSpecific: false,
          description: 'Link target — implies as="a"',
        },
        { name: 'onClick', type: '() => void', moveSpecific: false, description: 'Click handler.' },
        {
          ...
          moveSpecific: true,
          description:
            'Make the row a click target. Adds cursor, hover tint, focus ring, and Enter/Space activation. Defaults to true when `href`, `onClick`, or `as="a"|"button"` is set.',
        },
        {
          name: 'active',
          type: 'boolean',
        ...
        },
        {
          ...
          default: 'false',
          moveSpecific: true,
          description: 'Dims item and prevents interaction',
        },
        {
          name: 'children',
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Leading, Content, Trailing, or Meta children',
        },
      ],
      usesFactory: true,
      description:
        'Polymorphic list row with three-zone flex layout. Renders as li, a, or button based on as/href props.',
    },
    {
      name: 'Leading',
      slots: [
        {
          ...
          kind: 'none',
          typography: 'none',
          description: 'Leading visual slot',
        },
      ],
      props: [
        {
          ...
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Avatar, icon, checkbox, or other leading visual',
        },
      ],
      usesFactory: true,
      ...
      props: [
        {
          ...
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Title, Description, and any additional content',
        },
      ],
      usesFactory: true,
      ...
      props: [
        {
          ...
          moveSpecific: true,
          description:
            'Number of visible lines before truncation (line-clamp). Defaults to none — opt into truncation explicitly.',
        },
        {
          name: 'children',
          type: 'React.ReactNode',
      ...
      slots: [
        {
          ...
          kind: 'none',
          typography: 'none',
          description: 'Trailing content slot',
        },
      ],
      props: [
        {
          ...
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Badge, button, timestamp, menu, or other trailing content',
        },
      ],
      usesFactory: true,
  ...
  props: [
    {
      ...
      default: "'md'",
      moveSpecific: true,
      description: 'Controls padding, font size, gap',
    },
    {
      name: 'dividers',
      type: 'boolean',
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            slot: 'content',
            children: [{ slot: 'title' }, { slot: 'description', dataAttributes: ['data-lines'] }],
          },
          { slot: 'trailing' },
        ],
      },
  ...
  tokens: [
    {
      ...
      description: 'Horizontal gap between leading/content/trailing zones',
    },
    {
      name: '--move-list-padding-x',
      value: 'var(--move-spacing-md)',
      description: 'Horizontal padding on items',
    },
    {
      name: '--move-list-padding-y',
      value: 'var(--move-spacing-md)',
      description: 'Vertical padding on items (scaled by density)',
    },
    {
      name: '--move-list-divider-color',
      value: 'var(--move-border-base)',
      description: 'Divider line color between items',
    },
    {
      name: '--move-list-hover-bg',
      value: 'var(--move-surface-hover)',
      description: 'Background color on item hover (when hover enabled)',
    },
    {
      name: '--move-list-active-bg',
  ...
  renderContracts: [
    {
      id: 'three-zone-layout',
      description:
        'Item uses flex row with leading (flex-shrink-0), content (flex-1, min-width-0), and trailing (flex-shrink-0) zones ensuring correct truncation',
    },
    {
      id: 'content-truncation',
      description:
        'Content zone has min-width:0 so Title/Description text-overflow:ellipsis works within flex layout',
    },
    {
      id: 'title-truncation',
      description:
        'Title renders with single-line truncation (text-overflow: ellipsis, white-space: nowrap, overflow: hidden) by default',
    },
    {
      id: 'description-line-clamp',
      description:
        'Description supports line clamping via data-lines attribute: 1/2/3 use -webkit-line-clamp, none disables truncation',
    },
    {
      id: 'polymorphic-item',
      description:
        'Item renders as li by default, as a when href is provided, as button when as="button". Sets data-interactive when clickable.',
    },
    {
      id: 'dividers-between-items',
      description:
        'Dividers rendered between items (not around) via CSS border-bottom on items except :last-child, controlled by data-dividers on root',
    },
    {
      id: 'density-padding-scale',
      description:
        'Density compact/default/comfortable scales --move-list-padding-y: compact=spacing-xs, default=spacing-md, comfortable=spacing-lg',
    },
    {
      id: 'size-token-scale',
      description: 'Size sm/md/lg scales gap, padding, font sizes, and title weight proportionally',
    },
    {
      id: 'hover-highlight',
      description:
        'When data-hover on root, items show background transition on hover via --move-list-hover-bg',
    },
    {
      id: 'active-highlight',
      description:
        'Items with data-active show persistent background highlight via --move-list-active-bg',
    },
    {
      id: 'disabled-state',
      description: 'Items with data-disabled get reduced opacity and pointer-events: none',
    },
    {
      id: 'responsive-trailing-collapse',
      description:
        'Item uses container query — when item width is below threshold, trailing zone wraps below content zone',
    },
    {
      id: 'meta-auto-layout',
      description:
        'Meta renders Leading (if avatar provided) + Content > Title + Description from its props, forwarding lines to Description',
    },
    {
      id: 'context-propagation',
      description: 'Root provides size, density, hover context to Items for consistent styling',
    },
    {
      id: 'semantic-list',
      description:
        'Root renders as ul, Items as li (or a/button). Screen readers see a proper list structure.',
    },
  ],
