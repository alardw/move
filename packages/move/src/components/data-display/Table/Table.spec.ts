...
export const spec = {
  ...
  slots: [
    ...
    { name: 'footer', element: 'tfoot', typography: 'none', description: 'Table footer section.' },
    {
      name: 'row',
      element: 'tr',
      typography: 'none',
  ...
  subComponents: [
    {
      ...
      props: [
        {
          name: 'variant',
          type: "'surface' | 'lines' | 'bordered' | 'ghost'",
          default: "'lines'",
          moveSpecific: true,
          description:
            'Visual frame: borderless with horizontal rules (lines, default), card-like (surface), full grid (bordered), or no chrome at all (ghost — use with `striped` for zebra-only).',
        },
        {
          name: 'size',
          typeRef: 'Size',
        ...
        },
        {
          ...
          type: 'boolean',
          moveSpecific: true,
          description: 'Zebra-stripe even rows in the body. Composes with any variant.',
        },
        {
          name: 'hoverable',
          type: 'boolean',
          moveSpecific: true,
          description: 'Tint rows on hover.',
        },
        {
          name: 'stickyHeader',
          type: 'boolean',
          moveSpecific: true,
          description: 'Stick the header to the top while the body scrolls.',
        },
        {
          name: 'responsive',
          type: "'scroll' | 'stack' | 'none'",
          default: "'scroll'",
          moveSpecific: true,
          description:
            'Responsive strategy: overflow-x scroll (default), flip to stacked cards below stackBelow, or none.',
        },
        {
          name: 'stackBelow',
          type: 'number',
        ...
        },
        {
          ...
          moveSpecific: true,
          description: 'Staggered row entrance animation config or false to disable.',
        },
        {
          name: 'children',
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Table sections (Header, Body, Footer, Group).',
        },
      ],
      usesFactory: true,
      description:
        'Root table element wrapped by a scroll container. Provides context for row animations and column label inference used by stack mode.',
    },
    {
      name: 'Header',
      slots: [
        { name: 'header', element: 'thead', typography: 'none', description: 'Table header section.' },
      ],
      props: [
        {
          name: 'children',
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Header rows. Text inside Head cells is used as labels for stack mode.',
        },
      ],
      usesFactory: true,
      description:
        'Table header. On mount, extracts text from its Head children and registers the labels with Table context so body rows can render them in stack mode.',
    },
    {
      name: 'Body',
      slots: [{ name: 'body', element: 'tbody', typography: 'none', description: 'Table body section.' }],
      props: [
        {
          name: 'children',
          type: 'React.ReactNode',
      ...
      usesFactory: true,
      description:
        'Table body. Provides BodyContext so its descendant rows inject data-label onto each cell (for stack mode).',
    },
    {
      name: 'Footer',
      slots: [
    ...
    {
      name: 'Row',
      slots: [{ name: 'row', element: 'tr', typography: 'none', description: 'Table row.' }],
      props: [
        {
          name: 'selected',
          type: 'boolean',
        ...
        },
        {
          ...
          moveSpecific: true,
          description:
            'Make the row a click target. Adds cursor, hover tint, focus ring, and Enter/Space activation.',
        },
        {
          name: 'onClick',
        ...
        },
        {
          ...
          type: 'AnimationTrigger[] | false',
          moveSpecific: true,
          description: 'Row-level hover animation config or false to disable.',
        },
        {
          name: 'children',
          type: 'React.ReactNode',
      ...
      usesFactory: true,
      description:
        'Table row. Body-scoped rows clone their children with data-label so stack mode can render key/value pairs.',
    },
    {
      name: 'Head',
      slots: [{ name: 'head', element: 'th', typography: 'none', description: 'Header cell.' }],
      props: [
        {
          name: 'sortable',
          type: 'boolean',
          moveSpecific: true,
          description: 'Enable sort interaction on this column.',
        },
        {
          name: 'sorted',
          type: "'asc' | 'desc' | false",
          moveSpecific: true,
          description: 'Current sort direction or false.',
        },
        {
          name: 'onSort',
          type: '() => void',
          moveSpecific: true,
          description: 'Callback when sort is triggered.',
        },
        {
          name: 'align',
          type: "'start' | 'center' | 'end'",
          moveSpecific: true,
          description: 'Column alignment for the header label.',
        },
        {
          name: 'children',
          type: 'React.ReactNode',
      ...
      usesFactory: true,
      description:
        'Header cell with optional sortable behavior, keyboard interaction, sort indicator, and alignment.',
    },
    {
      name: 'Cell',
      slots: [{ name: 'cell', element: 'td', typography: 'meta', description: 'Data cell.' }],
      props: [
        {
          name: 'align',
          type: "'start' | 'center' | 'end'",
        ...
        },
        {
          ...
          moveSpecific: true,
          description:
            'When set, the cell renders its children as a bold primary line with this muted description below.',
        },
        {
          name: 'children',
          type: 'React.ReactNode',
      ...
      usesFactory: true,
      description:
        'Standard data cell. Supports alignment and an optional two-line "primary / description" layout. Rendered as key/value pair via CSS ::before + data-label when the table is in stack mode.',
    },
    {
      name: 'Caption',
      slots: [{ name: 'caption', element: 'caption', typography: 'ui', description: 'Table caption.' }],
      props: [
        {
          name: 'children',
          type: 'React.ReactNode',
      ...
      props: [
        {
          ...
          moveSpecific: true,
          description:
            'When false, the group renders as a static section — header has no chevron and is not clickable.',
        },
        {
          name: 'open',
          type: 'boolean',
        ...
        },
        {
          ...
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'GroupHeader followed by Rows.',
        },
      ],
      usesFactory: true,
      description:
        'Collapsible row group rendered as its own <tbody>. Non-header rows hide via CSS when the group is closed.',
    },
    {
      name: 'GroupHeader',
      slots: [
      ...
      props: [
        {
          ...
          moveSpecific: false,
          description:
            'Number of columns the header spans. Inferred from Table.Header column count by default.',
        },
        {
          name: 'children',
          type: 'React.ReactNode',
      ...
      usesFactory: true,
      description:
        'Clickable row that toggles its Group. role="button", aria-expanded bound to group open state.',
    },
  ],
  ...
  props: [
    {
      ...
      default: "'lines'",
      moveSpecific: true,
      description: 'Visual frame variant.',
    },
    {
      name: 'size',
      typeRef: 'Size',
    ...
    },
    {
      ...
      type: 'boolean',
      moveSpecific: true,
      description: 'Zebra-stripe body rows.',
    },
    { name: 'hoverable', type: 'boolean', moveSpecific: true, description: 'Tint rows on hover.' },
    {
      ...
      type: 'boolean',
      moveSpecific: true,
      description: 'Stick the header on scroll.',
    },
    {
      name: 'responsive',
      type: "'scroll' | 'stack' | 'none'",
    ...
    },
    {
      ...
      default: '640',
      moveSpecific: true,
      description: 'Stack-mode container breakpoint in px.',
    },
    {
      name: 'animations',
      type: 'AnimationTrigger[] | false',
      moveSpecific: true,
      description: 'Row entrance animation config or false.',
    },
    {
      name: 'children',
      type: 'React.ReactNode',
  ...
  anatomy: {
    ...
    children: [
      ...
      {
        slot: 'footer',
        children: [{ slot: 'row', children: [{ slot: 'cell' }] }],
      },
    ],
  },
  ...
  tokens: [
    ...
    {
      name: '--move-table-border',
      value: 'var(--move-border-base)',
      description: 'Outer frame color used by the surface and bordered variants.',
    },
    {
      name: '--move-table-radius',
      value: 'var(--move-rounded-lg)',
      description: 'Outer border radius (surface and bordered variants).',
    },
    {
      name: '--move-table-header-bg',
      value: 'transparent',
      description: 'Background behind the header row cells.',
    },
    {
      name: '--move-table-header-fg',
      value: 'var(--move-fg-base)',
      description: 'Header text color.',
    },
    {
      name: '--move-table-header-weight',
      value: 'var(--move-weight-semibold)',
      description: 'Header font weight.',
    },
    {
      name: '--move-table-header-border',
      value: 'var(--move-border-base)',
      description:
        'Color of the rule that sits under every header cell and separates the header from the body.',
    },
    {
      name: '--move-table-header-border-width',
      value: '1px',
      description: 'Thickness of the rule under the header row.',
    },
    {
      name: '--move-table-cell-padding-x',
      value: 'var(--move-spacing-md)',
      description: 'Horizontal cell padding.',
    },
    {
      name: '--move-table-cell-padding-y',
    ...
    {
      name: '--move-table-cell-border',
      value: 'color-mix(in oklch, var(--move-fg-base) 10%, transparent)',
      description: 'Color of the inter-row hairline that runs under each body cell.',
    },
    {
    ...
    {
      name: '--move-table-row-selected-bg',
      value: 'var(--move-selected-bg)',
      description:
        'Background for a row rendered with `selected` set (driven by useTableSelection or consumer state).',
    },
    {
    ...
    {
      name: '--move-table-caption-fg',
      value: 'var(--move-fg-muted)',
      description: 'Caption text color.',
    },
    {
      name: '--move-table-caption-size',
    ...
    {
      name: '--move-table-group-header-hover-bg',
      value: 'color-mix(in oklch, var(--move-fg-base) 8%, transparent)',
      description:
        'Hover background for a collapsible Group header row — matches the stronger interactive feedback when the header is clickable.',
    },
  ],
  ...
  renderContracts: [
    {
      id: 'scroll-wrapper',
      description:
        'Root always renders a wrapping div with container-type: inline-size so stack-mode observes container width.',
    },
    {
      id: 'stack-breakpoint',
      description:
        'When responsive="stack", a ResizeObserver on the wrapper toggles data-stack on the root table when its width drops below stackBelow (default 640px).',
    },
    {
      id: 'header-label-inference',
      description:
        'Table.Header collects text from its Head children in a useEffect and registers the labels with TableContext. Body rows clone each cell with data-label={labels[idx]}.',
    },
    {
      id: 'body-row-scope',
      description:
        'TableBodyContext is true inside Body and Group; only in-body rows inject data-label (header/footer rows do not).',
    },
    {
      id: 'row-selected-state',
      description: 'Row renders data-state="selected" when selected prop is true.',
    },
    {
      id: 'head-sort-indicator',
      description: 'Head renders an inline sort icon (↑ / ↓ / ↕) inside headContent when sortable.',
    },
    ...
    },
    {
      id: 'group-open-state',
      description:
        'Group renders data-open="true"/"false"; CSS hides non-groupHeader rows inside a closed group.',
    },
    {
      id: 'group-keyboard',
      description:
        'GroupHeader is role="button", tabIndex=0, responds to Enter/Space to toggle. Updates aria-expanded on the row.',
    },
    {
      id: 'group-colspan',
      description:
        'GroupHeader infers colSpan from the registered header labels length; override via colSpan prop.',
    },
    {
      id: 'row-hover-animation',
      description:
        'Row supports per-row hover animations via animations prop; event handlers delegate to useAnimations.',
    },
    { id: 'caption-bottom', description: 'Caption renders with caption-side: bottom.' },
    {
      id: 'stack-row-layout',
      description:
        'In stack mode rows render as flex columns of labeled cells; ::before pulls attr(data-label) for the key side.',
    },
  ],
