...
export const spec = {
  ...
  subComponents: [
    ...
    },
    {
      ...
      props: [
        ...
        { name: 'labels', type: 'Partial<RichTextEditorLabels>', moveSpecific: true, description: 'i18n label overrides (toolbar aria-label)' },
      ],
      usesFactory: true,
  ...
  renderContracts: [
    ...
    { id: 'toolbar-role-toolbar', description: 'Toolbar has role=toolbar and aria-label (default "Text formatting", overridable via labels.toolbar)' },
