...
export const spec = {
  ...
  slots: [
    ...
    { name: 'indicator', element: 'div', typography: 'none', description: 'Active-item indicator' },
  ],

  subComponents: [
    {
      name: 'Root',
      slots: [{ name: 'root', element: 'nav', typography: 'ui', description: 'Navigation landmark' }],
      props: [
        ...
        },
        {
          ...
          default: '80',
          moveSpecific: true,
          description: 'Top-of-viewport offset (in px) used to decide which heading is current',
        },
        {
          name: 'labels',
          type: 'Partial<TableOfContentsLabels>',
          moveSpecific: true,
          description: 'Override accessible label strings',
        },
      ],
      usesFactory: true,
      description:
        'Container and scroll-spy state manager. Tracks which registered heading intersects the viewport above the offset line and exposes activeHref via context.',
    },
    {
      name: 'Item',
      slots: [
        { name: 'item', element: 'a', typography: 'ui', description: 'Anchor link to a page heading' },
      ],
      props: [
        { name: 'className', type: 'string', moveSpecific: false, description: 'CSS class name' },
        {
        ...
        },
        {
          ...
          type: 'string',
          moveSpecific: false,
          description: 'Anchor href — e.g. "#section-id"',
        },
        {
          name: 'depth',
          type: '1 | 2 | 3 | 4',
          default: '1',
          moveSpecific: true,
          description: 'Nesting level; visually indents the item',
        },
      ],
      usesFactory: true,
      description:
        'Anchor link that registers its href with the Root, applies data-active when current, and smooth-scrolls to the target on click.',
    },
  ],
  ...
  anatomy: {
    slot: 'root',
    children: [{ slot: 'item', dataAttributes: ['data-active', 'data-depth'] }],
  },
  ...
  renderContracts: [
    {
      id: 'scroll-spy',
      description:
        'Root uses IntersectionObserver to watch all registered heading elements; data-active lands on the first Item whose target is intersecting the viewport above the offset line.',
    },
    {
      id: 'smooth-scroll',
      description:
        'Clicking an Item scrolls its target heading into view with behavior:smooth and updates the URL hash without pushing history.',
    },
    {
      id: 'aria-current',
      description: 'Active Item gets aria-current="location" for screen reader support.',
    },
  ...
  tokens: [
    {
      name: '--move-toc-indicator-color',
      value: 'var(--move-primary)',
      description: 'Left-border indicator color on the active item',
    },
    {
    ...
    },
    {
      ...
      description: 'Vertical rail color running alongside the items',
    },
    {
      name: '--move-toc-item-fg',
      value: 'var(--move-fg-muted)',
      description: 'Default item text color',
    },
    {
      name: '--move-toc-item-fg-hover',
    ...
    {
      name: '--move-toc-item-font-size',
      value: 'var(--move-size-sm)',
      description: 'Item text size',
    },
    {
      name: '--move-toc-item-padding-x',
