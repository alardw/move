...
export const spec = {
  ...
  tokens: [
    ...
    { name: '--move-sidebar-bg', value: 'var(--move-surface-bg)', description: 'Sidebar background color' },
    ...
    { name: '--move-sidebar-item-bg-hover', value: 'var(--move-surface-hover)', description: 'Item background on hover' },
