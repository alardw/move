...
export const spec = {
  ...
  slots: [
    ...
    },
    {
      ...
      kind: 'control',
      typography: 'none',
      description: 'Previous page trigger button',
    },
    {
      name: 'next',
      element: 'button',
      kind: 'control',
      typography: 'ui',
      description: 'Next page trigger button',
    },
    {
      name: 'items',
      element: 'ul',
    ...
    },
    {
      ...
      kind: 'item',
      typography: 'ui',
      description: 'Individual page number button',
    },
    {
      name: 'ellipsis',
      element: 'span',
      ...
      slots: [
        {
          ...
          kind: 'none',
          typography: 'none',
          description: 'Page list container',
        },
        {
          name: 'item',
          element: 'button',
        ...
        },
        {
          ...
          kind: 'none',
          typography: 'ui',
          description: 'Ellipsis between ranges',
        },
        {
          name: 'indicator',
          element: 'div',
