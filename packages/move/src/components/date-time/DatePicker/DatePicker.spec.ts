...
export const spec = {
  ...
  slots: [
    ...
    { name: 'icon', element: 'span', typography: 'none', description: 'Calendar icon slot' },
    {
      name: 'content',
      element: 'div',
      typography: 'none',
  ...
  subComponents: [
    {
      name: 'Trigger',
      slots: [
        { name: 'trigger', element: 'div', typography: 'none', description: 'Popover anchor area' },
      ],
      props: [
        {
          name: 'children',
      ...
      usesFactory: false,
      description:
        'Anchor element for the calendar popover (div, not button — a button containing inputs is invalid HTML)',
    },
    {
      name: 'Input',
      slots: [
        ...
        { name: 'rangeWrapper', element: 'div', typography: 'none', description: 'Range mode layout' },
      ],
      props: [
        {
          name: 'placeholder',
      ...
      usesFactory: false,
      description:
        'Smart input that dispatches to SingleInput or RangeInput based on mode from CalendarContext',
    },
    {
      name: 'Icon',
      ...
      props: [
        {
          ...
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Custom icon content (defaults to calendar icon)',
        },
      ],
      usesFactory: false,
    ...
    },
    {
      ...
      slots: [
        ...
        { name: 'datePickerTime', element: 'div', typography: 'none', description: 'Time field section' },
      ],
      props: [
        {
          name: 'sideOffset',
      ...
      usesFactory: false,
      description:
        'Animated popover content with bake-in portaling, enter/exit transitions, and day-cell stagger.',
    },
  ],
  ...
  props: [
    // Animation
    {
      ...
      moveSpecific: true,
      description: 'Animation config for open/close transitions',
    },
    // Controlled open
    ...
    // Behavior
    {
      ...
      default: 'true',
      moveSpecific: true,
      description: 'Close popover after date selection',
    },
    // Selection
    {
      name: 'mode',
    ...
    },
    {
      ...
      type: 'number',
      moveSpecific: true,
      description: 'First day of week (0=Sun, 1=Mon, etc.)',
    },
    {
      name: 'constraints',
      type: 'CalendarConstraints',
      moveSpecific: true,
      description: 'Date constraints (min, max, disabled dates)',
    },
    {
      name: 'numberOfMonths',
      type: 'number',
    ...
    },
    {
      ...
      type: 'number',
      moveSpecific: true,
      description: 'Year range for year picker navigation',
    },
    {
      name: 'fixedWeeks',
      type: 'boolean',
    ...
    // Renderers
    {
      ...
      type: 'RenderDayCell',
      moveSpecific: true,
      description: 'Custom day cell renderer',
    },
    {
      name: 'renderEvent',
      type: 'RenderEvent',
      moveSpecific: true,
      description: 'Custom event renderer',
    },
    // Labels / i18n
    {
      name: 'placeholder',
    ...
    {
      name: 'rangeLabels',
      type: 'DatePickerRangeLabels',
      moveSpecific: true,
      description: 'Custom labels for range from/to fields',
    },
    {
      name: 'labels',
      type: 'DatePickerLabels',
      moveSpecific: true,
      description: 'Custom UI labels for accessibility and display',
    },
    // Time
    {
      name: 'showTime',
      type: "boolean | { hourCycle?: 12 | 24; placement?: 'inline' | 'popup' }",
      default: 'false',
      moveSpecific: true,
      description: 'Show time picker integration',
    },
    // Standard
    {
      name: 'children',
      type: 'React.ReactNode',
      moveSpecific: false,
      description: 'DatePicker sub-components (Trigger, Input, Portal, Content)',
    },
  ],
  ...
  labels: [
    {
      key: 'selectDate',
      default: 'Select date',
      description: 'Placeholder for single/multiple mode input',
    },
    {
      key: 'datesSelected',
      default: '{count} dates selected',
      description: 'Display text for multiple date selection (template)',
    },
    ...
    { key: 'endDate', default: 'End date', description: 'Range to-input aria-label' },
    {
      ...
      description: 'Range instruction label for from field',
    },
    {
      key: 'selectEndDate',
