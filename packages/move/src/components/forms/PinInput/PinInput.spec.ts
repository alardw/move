...
export const spec = {
  ...
  props: [
    ...
    },
    {
      ...
      default: "'number'",
      moveSpecific: true,
      description: 'Character validation type',
    },
    {
      name: 'mask',
      type: 'boolean',
      moveSpecific: true,
      description: 'Mask input like a password (shows bullet characters)',
    },
    {
      name: 'placeholder',
      type: 'string',
    ...
    },
    {
      ...
      type: 'number[]',
      moveSpecific: true,
      description: 'Grouping pattern (e.g. [3,3] splits 6 into two groups with separator)',
    },
    {
      name: 'invalid',
      type: 'boolean',
  ...
  anatomy: {
    ...
    children: [{ slot: 'slot', dataAttributes: ['data-active', 'data-placeholder'] }],
  },
  ...
  renderContracts: [
    {
      id: 'single-hidden-input',
      description:
        'A single hidden input element captures all keyboard/paste input, positioned absolutely over the root with opacity:0',
    },
    {
      id: 'visual-slots-only',
      description:
        'Slot elements are purely visual divs — they display characters from the hook value but are not interactive inputs',
    },
    {
      id: 'root-click-focuses-input',
      description: 'Clicking the root focuses the hidden input, allowing typing',
    },
    {
      id: 'caret-in-active-slot',
      description:
        'Active slot (focused and not filled) shows a blinking caret div instead of a character',
    },
    {
      id: 'grouping-with-separators',
      description:
        'When grouping is set, slots are split into visual groups with en-dash separators between them',
    },
    {
      id: 'groups-sum-must-equal-length',
      description:
        'If grouping array sum does not equal length, fallback to single group of length',
    },
    {
      id: 'mask-shows-bullets',
      description:
        'When mask=true, filled slots show bullet character instead of actual characters',
    },
    {
      id: 'on-complete-fires-when-full',
      description: 'onComplete callback fires when value length equals configured length',
    },
    {
      id: 'type-filters-characters',
      description:
        'Character validation via type prop: "number" allows digits only, "alphanumeric" allows [a-zA-Z0-9], RegExp allows custom pattern',
    },
    {
      id: 'paste-support',
      description:
        'Paste event is intercepted and filtered through character validation before setting value',
    },
    {
      id: 'autofocus-on-mount',
      description: 'When autoFocus=true, pin.focus() is called on mount via useEffect',
    },
    {
      id: 'one-time-code-autocomplete',
      description:
        'When oneTimeCode=true, hidden input has autocomplete="one-time-code" for SMS autofill',
    },
  ],

  tokens: [
    {
      name: '--move-pininput-slot-size',
      value: 'var(--move-control-height-md)',
      description: 'Slot width and height (square)',
    },
    {
      name: '--move-pininput-slot-radius',
      value: 'var(--move-rounded-md)',
      description: 'Slot border radius',
    },
    {
      name: '--move-pininput-slot-border',
      value: 'var(--move-border-base)',
      description: 'Slot border color',
    },
    {
      name: '--move-pininput-slot-border-hover',
      value: 'var(--move-border-emphasis)',
      description: 'Slot hover border color',
    },
    {
      name: '--move-pininput-slot-border-focus',
      value: 'var(--move-primary)',
      description: 'Active slot border/focus ring color',
    },
    {
    ...
    {
      name: '--move-pininput-slot-fg',
      value: 'var(--move-fg-base)',
      description: 'Slot text color',
    },
    {
      name: '--move-pininput-slot-font-size',
      value: 'var(--move-size-lg)',
      description: 'Slot character font size',
    },
    {
      name: '--move-pininput-slot-gap',
      value: 'var(--move-spacing-sm)',
      description: 'Gap between slots within a group',
    },
    {
      name: '--move-pininput-group-gap',
      value: 'var(--move-spacing-md)',
      description: 'Gap between groups',
    },
    {
      name: '--move-pininput-placeholder-fg',
      value: 'var(--move-fg-muted)',
      description: 'Placeholder character color',
    },
    {
      name: '--move-pininput-caret-color',
      value: 'var(--move-primary)',
      description: 'Blinking caret color',
    },
  ],
  ...
  labels: [
    {
      key: 'pinInput',
      default: 'PIN input',
      description: 'Default aria-label for the hidden input element',
    },
  ],
