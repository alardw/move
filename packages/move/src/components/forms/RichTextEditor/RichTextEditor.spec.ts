...
export const spec = {
  ...
  subComponents: [
    {
      ...
      props: [
        ...
        },
        {
          ...
          moveSpecific: false,
          description: 'Toolbar and Content sub-components',
        },
        {
          name: 'variant',
          type: "'outline' | 'subtle'",
          default: "'outline'",
          moveSpecific: true,
          description: 'Visual variant — outline has border, subtle is borderless',
        },
        {
          name: 'size',
          typeRef: 'Size',
          ...
          moveSpecific: true,
          description:
            'Component size affecting control size, toolbar padding, and content padding',
        },
      ],
      usesFactory: false,
      description:
        'Context provider and visual wrapper; plain FC that provides variant/size via RichTextEditorContext',
    },
    {
      name: 'Toolbar',
      ...
      props: [
        ...
        },
        {
          ...
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'ControlGroup, Control, and Separator sub-components',
        },
        {
          name: 'sticky',
          type: 'boolean',
          moveSpecific: true,
          description: 'Make toolbar sticky at the top of the scroll container',
        },
        {
          name: 'stickyOffset',
          type: 'number',
          moveSpecific: true,
          description: 'Top offset for sticky positioning (px)',
        },
        {
          name: 'labels',
          type: 'Partial<RichTextEditorLabels>',
          moveSpecific: true,
          description: 'i18n label overrides (toolbar aria-label)',
        },
      ],
      usesFactory: true,
      description:
        'Toolbar container with role=toolbar, optional sticky positioning, and flexbox wrapping',
    },
    {
      name: 'ControlGroup',
      ...
      props: [
        ...
        },
        {
          ...
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Control sub-components',
        },
      ],
      usesFactory: true,
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Control icon or label',
        },
        {
          name: 'active',
          type: 'boolean',
          moveSpecific: true,
          description: 'Controlled active/pressed state',
        },
        {
          name: 'defaultActive',
          type: 'boolean',
          default: 'false',
          moveSpecific: true,
          description: 'Default active state (uncontrolled)',
        },
        {
          name: 'onActiveChange',
          type: '(active: boolean) => void',
          moveSpecific: true,
          description: 'Called when active state toggles',
        },
        { name: 'disabled', type: 'boolean', moveSpecific: false, description: 'Disabled state' },
      ],
      usesFactory: true,
      description:
        'Individual formatting toggle button with controlled/uncontrolled active state via useControlledState',
    },
    {
      name: 'Separator',
      ...
      usesFactory: true,
      description:
        'Vertical separator bar between control groups with role=separator and aria-orientation=vertical',
    },
    {
      name: 'Content',
      ...
      props: [
        ...
        },
        {
          ...
          type: 'React.ReactNode',
          moveSpecific: false,
          description: 'Editor engine component (TipTap, Lexical, Plate, etc.)',
        },
        {
          name: 'minHeight',
      ...
      usesFactory: true,
      description:
        'Content area wrapping children in Prose for rich text typography; strips focus outlines from contenteditable elements',
    },
  ],
        ...
        children: [
          {
            ...
            children: [{ slot: 'control', dataAttributes: ['data-active'] }],
          },
          {
            slot: 'separator',
  ...
  tokens: [
    ...
    // Toolbar tokens
    {
      name: '--move-rte-toolbar-bg',
      value: 'var(--move-bg-subtle)',
      description: 'Toolbar background color',
    },
    {
      name: '--move-rte-toolbar-border',
      value: 'var(--move-border-base)',
      description: 'Toolbar bottom border color',
    },
    {
      name: '--move-rte-toolbar-padding',
      value: 'var(--move-spacing-sm)',
      description: 'Toolbar internal padding',
    },
    {
      name: '--move-rte-toolbar-gap',
      value: 'var(--move-spacing-xs)',
      description: 'Gap between toolbar items',
    },
    // Control tokens
    {
      name: '--move-rte-control-size',
      value: '28px',
      description: 'Control button width and height (md)',
    },
    {
      name: '--move-rte-control-radius',
      value: 'var(--move-rounded-sm)',
      description: 'Control button border radius',
    },
    {
      name: '--move-rte-control-fg',
      value: 'var(--move-fg-muted)',
      description: 'Control default foreground color',
    },
    {
      name: '--move-rte-control-fg-hover',
      value: 'var(--move-fg-base)',
      description: 'Control foreground color on hover',
    },
    {
      name: '--move-rte-control-bg-hover',
      value: 'var(--move-bg-muted)',
      description: 'Control background color on hover',
    },
    {
      name: '--move-rte-control-fg-active',
      value: 'var(--move-primary-fg)',
      description: 'Control foreground color when active',
    },
    {
      name: '--move-rte-control-bg-active',
      value: 'var(--move-primary)',
      description: 'Control background color when active',
    },
    // Content tokens
    {
      name: '--move-rte-content-padding',
      value: 'var(--move-spacing-md)',
      description: 'Content area internal padding',
    },
    {
      name: '--move-rte-content-fg',
      value: 'var(--move-fg-base)',
      description: 'Content text color',
    },
    {
      name: '--move-rte-content-min-height',
      value: '200px',
      description: 'Content area minimum height',
    },
    // Separator tokens
    {
      name: '--move-rte-separator-color',
      value: 'var(--move-border-base)',
      description: 'Separator bar color',
    },
  ],
  ...
  labels: [
    {
      ...
      description: 'Default aria-label for the toolbar',
    },
  ],
  ...
  renderContracts: [
    {
      id: 'root-is-plain-fc',
      description:
        'Root is a plain React.FC (not withMoveComponent) that provides RichTextEditorContext with variant and size',
    },
    {
      id: 'root-sets-data-attributes',
      description:
        'Root sets data-variant and data-size on the wrapper div for CSS token overrides',
    },
    {
      id: 'outline-variant-border',
      description:
        'Outline variant renders 1px solid border; subtle variant renders no border and transparent toolbar background',
    },
    {
      id: 'toolbar-role-toolbar',
      description:
        'Toolbar has role=toolbar and aria-label (default "Text formatting", overridable via labels.toolbar)',
    },
    {
      id: 'toolbar-sticky',
      description:
        'When sticky=true, toolbar gets position:sticky and top:0 (or stickyOffset value)',
    },
    {
      id: 'control-group-role-group',
      description: 'ControlGroup has role=group for ARIA grouping of related controls',
    },
    {
      id: 'control-uses-controlled-state',
      description:
        'Control uses useControlledState for active/defaultActive/onActiveChange triad; toggles on click unless disabled',
    },
    {
      id: 'control-data-active',
      description: 'Control sets data-active attribute when active for CSS styling (primary bg/fg)',
    },
    {
      id: 'separator-role-separator',
      description: 'Separator has role=separator and aria-orientation=vertical',
    },
    {
      id: 'content-wraps-in-prose',
      description: 'Content wraps children in Prose component for consistent rich text typography',
    },
    {
      id: 'content-strips-outlines',
      description:
        'Content CSS strips focus outlines from [contenteditable], .tiptap, and other editor engine elements',
    },
    {
      id: 'content-editor-overrides',
      description:
        'Content CSS provides editor-specific overrides for task lists (TipTap, Lexical) and nested list style cycling',
    },
    {
      id: 'size-token-overrides',
      description:
        'Size variants override control-size (sm=24px, lg=36px), toolbar padding, toolbar gap, and content padding via CSS token reassignment',
    },
    {
      id: 'editor-agnostic',
      description:
        'Component is editor-agnostic chrome only — does not import or depend on any specific editor engine',
    },
  ],
  ...
  testing: {
    behaviors: [
      ...
      'Toolbar renders with custom aria-label via labels.toolbar',
