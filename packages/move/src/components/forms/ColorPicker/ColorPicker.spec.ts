...
export const spec = {
  ...
  slots: [
    {
      ...
      kind: 'none',
      typography: 'none',
      description: 'Vertical flex container for all picker sections',
    },
    {
      name: 'saturation',
      element: 'div',
      kind: 'control',
      typography: 'none',
      description: '2D saturation/brightness area with crosshair cursor and draggable indicator',
    },
    {
      name: 'hue',
      element: 'div',
      kind: 'control',
      typography: 'none',
      description: 'Horizontal hue slider (0-360 rainbow gradient) with draggable thumb',
    },
    {
      name: 'alpha',
      element: 'div',
      kind: 'control',
      typography: 'none',
      description: 'Horizontal alpha slider (checkerboard + color gradient) with draggable thumb',
    },
    {
      name: 'swatches',
      element: 'div',
      kind: 'none',
      typography: 'none',
      description: 'Grid of preset color swatch buttons',
    },
    {
      name: 'inputRow',
      element: 'div',
      kind: 'none',
      typography: 'none',
      description: 'Row containing format selector and channel inputs',
    },
    {
      name: 'formatSelect',
      element: 'select',
      kind: 'none',
      typography: 'meta',
      description: 'Native select for switching color format (hex/rgb/hsl)',
    },
    {
      name: 'channelInput',
      element: 'input',
      kind: 'none',
      typography: 'meta',
      description: 'Individual channel input (R/G/B, H/S/L, or hex)',
    },
    {
      name: 'alphaInput',
      element: 'input',
      kind: 'none',
      typography: 'meta',
      description: 'Alpha percentage input (0-100)',
    },
  ],
  ...
  props: [
    ...
    },
    {
      ...
      moveSpecific: true,
      description: 'Called when format changes via selector',
    },
    {
      name: 'formatOptions',
      type: 'BaseColorFormat[]',
      moveSpecific: true,
      description: 'Available base formats in selector (defaults to [hex, rgb, hsl])',
    },
    // Swatches
    {
      name: 'swatches',
      type: 'string[]',
      moveSpecific: true,
      description: 'Preset color swatch values',
    },
    {
      name: 'swatchesPerRow',
      type: 'number',
      default: '7',
      moveSpecific: true,
      description: 'Number of swatches per grid row',
    },
    // Sections
    {
      name: 'withPicker',
    ...
    // Labels
    {
      ...
      moveSpecific: true,
      description: 'Accessible label overrides for picker controls',
    },
    // State
    { name: 'disabled', type: 'boolean', moveSpecific: false, description: 'Disabled state' },
    {
      ...
      type: 'boolean',
      moveSpecific: true,
      description: 'Read-only state (pointer-events: none)',
    },
    // Standard
  ...
  renderContracts: [
    ...
    {
      id: 'saturation-pointer-drag',
      description:
        'Saturation area uses pointer capture drag for continuous S/V updates; X maps to saturation (0-100%), Y maps to brightness (inverted 0-100%)',
    },
    {
      id: 'saturation-bg-pure-hue',
      description:
        'Saturation area background-color is set to pure hue hex (S=100, V=100) with CSS gradients for white-to-transparent and black-to-transparent overlays',
    },
    {
      id: 'hue-pointer-drag',
      description: 'Hue slider uses pointer capture drag; X position maps to hue 0-360',
    },
    {
      id: 'alpha-pointer-drag',
      description:
        'Alpha slider uses pointer capture drag; X position maps to alpha 0-1; only visible when format has alpha channel',
    },
    {
      id: 'alpha-checkerboard-bg',
      description:
        'Alpha slider has checkerboard pattern background with gradient overlay from transparent to current color',
    },
    {
      id: 'drag-commit-on-end',
    ...
    {
      id: 'alpha-format-awareness',
      description:
        'Alpha slider and alpha input only show when format has alpha channel (hexa, rgba, hsla)',
    },
    {
      id: 'hex-input-mode',
      description:
        'When base format is hex, a single text input replaces channel inputs; focus/blur for local editing with validation',
    },
    {
      id: 'channel-inputs-mode',
      description:
        'When base format is rgb/hsl, individual numeric inputs for each channel with focus/blur commit and ArrowUp/Down nudge (Shift=10)',
    },
    {
      id: 'swatch-click-sets-color',
      description:
        'Swatch button click calls setFromString + commitChange to set the color and fire onChangeEnd',
    },
    {
      id: 'with-picker-toggle',
      description:
        'When withPicker=false, saturation area, hue slider, and alpha slider are hidden',
    },
    {
      id: 'input-row-always-shown',
      description:
        'Input row with format selector and channel inputs is always rendered regardless of withPicker',
    },
    {
      id: 'cursor-position-tracks-hsv',
      description: 'Saturation cursor positioned at (S%, 100-V%) reflecting current color',
    },
    {
      id: 'thumb-position-tracks-value',
      description: 'Hue thumb at (H/360*100)%, alpha thumb at (A*100)%',
    },
  ],
  ...
  tokens: [
    {
      name: '--move-colorpicker-width',
      value: '260px',
      description: 'Root width (varies by size)',
    },
    {
      name: '--move-colorpicker-saturation-height',
      value: '160px',
      description: 'Saturation area height',
    },
    {
      name: '--move-colorpicker-slider-height',
      value: '14px',
    ...
    },
    {
      ...
      description: 'Saturation area border radius',
    },
    {
      name: '--move-colorpicker-swatch-size',
      value: '28px',
      description: 'Individual swatch button size',
    },
    {
      name: '--move-colorpicker-gap',
      value: 'var(--move-spacing-sm)',
      description: 'Gap between picker sections',
    },
    {
      name: '--move-colorpicker-cursor-size',
      value: '14px',
      description: 'Saturation crosshair cursor diameter',
    },
    {
      name: '--move-colorpicker-input-height',
      value: '28px',
      description: 'Channel input and format select height',
    },
    {
      name: '--move-colorpicker-input-font',
      value: 'var(--move-size-xs)',
      description: 'Channel input font size',
    },
  ],
  ...
  labels: [
    {
      key: 'saturation',
      default: 'Color saturation and brightness',
      description: 'Saturation area accessible label',
    },
    ...
    {
      key: 'saturationChannel',
      default: 'Saturation',
      description: 'Saturation channel input accessible label',
    },
    {
      key: 'lightness',
      default: 'Lightness',
