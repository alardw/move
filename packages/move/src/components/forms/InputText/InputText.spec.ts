...
export const spec = {
  ...
  props: [
    ...
    },
    {
      ...
      default: "'md'",
      moveSpecific: true,
      description: 'Size controlling height and font size',
    },
    {
      name: 'invalid',
      type: 'boolean',
    ...
    },
    {
      ...
      moveSpecific: true,
      description: 'Explicit width override for the root wrapper',
    },
    {
      name: 'disabled',
      type: 'boolean',
  ...
  tokens: [
    ...
    {
      name: '--move-input-placeholder',
      value: 'var(--move-fg-subtle)',
      description: 'Input placeholder text color',
    },
    {
      name: '--move-input-height',
      value: 'var(--move-control-height-md)',
      description: 'Input height',
    },
    {
      name: '--move-input-icon-color',
      value: 'var(--move-fg-muted)',
      description: 'Icon slot color',
    },
    {
      name: '--move-input-icon-gap',
      value: 'var(--move-spacing-sm)',
      description: 'Gap between icons and input',
    },
  ],
  ...
  renderContracts: [
    {
      ...
      description: 'Clicking anywhere on the root wrapper focuses the native input element',
    },
    {
      id: 'icon-conditional-render',
      description:
        'iconLeft and iconRight slots are only rendered when their respective props are provided',
    },
    {
      id: 'icon-aria-hidden',
      description: 'Icon slots are marked aria-hidden="true" since they are decorative',
    },
    {
    ...
    },
    {
      id: 'attrs-on-input',
      description:
        'Remaining HTML attributes (attrs) are spread onto the native input element, not root',
    },
    {
      id: 'ref-on-input',
      description:
        'Forwarded ref is merged and attached to the native input element via useMergedRef',
    },
    {
