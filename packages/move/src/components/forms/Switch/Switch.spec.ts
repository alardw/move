...
export const spec = {
  ...
  category: 'forms',
  description:
    'Toggle switch built on Radix Switch with animated thumb, size variants, and optional inline label',
  ...
  subComponents: [
    {
      ...
      description:
        'Switch track that manages checked state via Radix Switch.Root, with optional wrapper label',
    },
    {
      name: 'Thumb',
      slots: [
        { name: 'thumb', element: 'span', typography: 'none', description: 'Sliding thumb indicator' },
      ],
      props: [
        { name: 'className', type: 'string', moveSpecific: false, description: 'CSS class name' },
        {
      ...
      description:
        'Sliding thumb that translates horizontally on toggle, animated via shared context',
    },
  ],
  ...
  tokens: [
    ...
    { name: '--move-switch-height', value: '1.75rem', description: 'Switch track height' },
    {
      ...
      description: 'Unchecked track background color',
    },
    {
      name: '--move-switch-bg-checked',
      value: 'var(--move-primary)',
      description: 'Checked track background color',
    },
    {
      name: '--move-switch-radius',
      value: 'var(--move-rounded-full)',
      description: 'Track border radius (pill shape)',
    },
    {
      name: '--move-switch-padding',
      value: '3px',
      description: 'Inner padding between track edge and thumb',
    },
    {
      name: '--move-switch-transition',
      value: 'var(--move-transition-fast)',
      description: 'Background color transition duration',
    },
    {
      name: '--move-switch-thumb-bg',
      value: 'var(--move-white, #fff)',
      description: 'Thumb background color',
    },
    {
      name: '--move-switch-thumb-shadow',
  ...
  renderContracts: [
    {
      id: 'radix-switch-root',
      description:
        'Root renders as Radix Switch.Root which provides built-in role="switch", aria-checked, and keyboard toggle',
    },
    {
      id: 'radix-switch-thumb',
      description:
        'Thumb renders as Radix Switch.Thumb with data-state="checked"/"unchecked" from Radix',
    },
    {
      id: 'context-shares-animation',
      description: 'SwitchContext shares animation state between Root and Thumb sub-components',
    },
    {
      id: 'thumb-dual-ref',
      description:
        'Thumb merges forwarded ref with both rootRef and indicatorRef from toggle animation for press and translate animation',
    },
    {
      id: 'onsetup-dynamic-translate',
      description:
        'Thumb translateX distance computed dynamically based on measured track/thumb widths',
    },
    {
      id: 'label-wrapper',
      description:
        'When label prop is provided, Root is wrapped in a <label> element with the label text beside the switch',
    },
    {
      id: 'press-handlers-on-root',
      description:
        'Press animation handlers (onMouseDown, onMouseUp, onMouseLeave) are attached to the Radix Switch.Root via Root.press trigger',
    },
    {
      id: 'invalid-inset-shadow',
      description:
        'Invalid state uses inset box-shadow with --move-error instead of border to avoid layout shift',
    },
    {
      id: 'radix-handles-form',
      description:
        'Radix Switch handles hidden input for form submission internally via name/value props',
    },
  ],
