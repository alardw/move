...
export const spec = {
  ...
  slots: [
    ...
    { name: 'message', element: 'div', typography: 'none', description: 'Primary toast message text' },
    {
      name: 'description',
      element: 'div',
      typography: 'meta',
  ...
  subComponents: [
    {
      name: 'Viewport',
      slots: [
        { name: 'viewport', element: 'div', typography: 'none', description: 'Viewport container' },
      ],
      props: [
