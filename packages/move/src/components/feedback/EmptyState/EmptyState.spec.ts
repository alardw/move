...
export const spec = {
  ...
  props: [
    {
      ...
      type: 'string',
      moveSpecific: true,
      description: 'Icon name to display above the title',
    },
    {
      name: 'title',
    ...
    },
    {
      ...
      type: 'React.ReactNode',
      moveSpecific: true,
      description: 'Action content (e.g. button) rendered below description',
    },
    {
      name: 'size',
      typeRef: 'Size',
      default: "'md'",
      moveSpecific: true,
      description: 'Controls padding, gap, and typography sizes',
    },
    {
      name: 'children',
      type: 'React.ReactNode',
      moveSpecific: false,
      description: 'Additional content rendered after structured slots',
    },
  ],
  ...
  tokens: [
    {
      name: '--move-emptystate-icon-fg',
      value: 'var(--move-fg-subtle)',
      description: 'Icon color',
    },
    {
      name: '--move-emptystate-title-fg',
      value: 'var(--move-fg-base)',
      description: 'Title text color',
    },
    {
      name: '--move-emptystate-description-fg',
      value: 'var(--move-fg-muted)',
      description: 'Description text color',
    },
    {
      name: '--move-emptystate-padding',
      value: 'var(--move-spacing-xl)',
      description: 'Container padding (varies by size)',
    },
    {
      name: '--move-emptystate-gap',
      value: 'var(--move-spacing-sm)',
      description: 'Gap between slots (varies by size)',
    },
  ],
  ...
  renderContracts: [
    ...
    {
      id: 'description-conditional',
      description: 'Description slot only renders when description prop is provided',
    },
    {
      id: 'action-conditional',
      description: 'Action slot only renders when action prop is provided',
    },
    {
      id: 'icon-size-mapping',
      description: 'Icon size maps to sm=32, md=44, lg=56 based on the size prop',
    },
    {
      id: 'icon-aria-hidden',
      description: 'Icon wrapper has aria-hidden="true" since it is decorative',
    },
  ],
