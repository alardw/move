...
export const spec = {
  ...
  rootElement: 'div',
  slots: [
    { name: 'root', element: 'div', description: 'Outer container with flex layout, background, and keyboard event handling' },
    ...
    { name: 'subtitleButton', element: 'button', description: 'Subtitle toggle button rendered via Button component' },
    { name: 'subtitleOverlay', element: 'div', description: 'Subtitle cue text overlay positioned above the player bar' },
  ],
  ...
  props: [
    ...
    { name: 'onReady', type: '() => void', moveSpecific: true, description: 'Called when audio metadata is loaded and ready' },
    ...
    { name: 'showSubtitles', type: 'boolean', default: 'true', moveSpecific: true, description: 'Show the subtitles toggle button (only if subtitles are provided)' },
  ...
  tokens: [
    ...
    { name: '--move-audioplayer-progress-buffered', value: 'rgba(255, 255, 255, 0.3)', description: 'Buffered progress indicator color' },
  ...
  renderContracts: [
    { id: 'hidden-audio-element', description: 'A hidden <audio> element is rendered inside root with preload="metadata"; all playback is controlled programmatically via useAudioPlayer hook' },
    ...
    { id: 'subtitle-overlay-conditional', description: 'Subtitle overlay only renders when there is an active cue (player.activeCue is non-null)' },
    { id: 'subtitle-toggle', description: 'Subtitle button toggles between enabling first/default track and disabling all subtitles' },
    ...
    { id: 'show-controls-conditional', description: 'showSettings, showSubtitles (requires subtitles prop), showVolume, and showTime conditionally render their respective controls' },
    { id: 'keyboard-shortcuts', description: 'Space/k toggles play, m toggles mute, ArrowLeft/Right seeks +/-5s, ArrowUp/Down adjusts volume +/-5%' },
    { id: 'button-composition', description: 'Play, volume, subtitle, and settings buttons are rendered using the Button component with variant="ghost" size="sm"' },
  ],
