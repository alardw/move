...
export const spec = {
  ...
  slots: [
    ...
    { name: 'indicator', element: 'div', description: 'Sliding background indicator that follows the active page button' },
  ],
  ...
  subComponents: [
    {
      ...
      props: [
        ...
        { name: 'page', type: 'number', moveSpecific: true, description: 'Controlled active page (1-based)' },
        { name: 'defaultPage', type: 'number', moveSpecific: true, description: 'Initial page for uncontrolled mode (1-based)' },
      ...
      usesFactory: true,
      description: 'Root container that provides pagination state (via usePagination hook) and visual config to children via context',
    },
    {
      name: 'PrevTrigger',
      ...
      usesFactory: true,
      description: 'Previous page button that disables when on first page; uses interactive animation hook',
    },
    {
      name: 'NextTrigger',
      ...
      usesFactory: true,
      description: 'Next page button that disables when on last page; uses interactive animation hook',
    },
    {
      name: 'Items',
      slots: [
  ...
  props: [
    { name: 'total', type: 'number', moveSpecific: true, description: 'Total number of pages' },
    { name: 'page', type: 'number', moveSpecific: true, description: 'Controlled active page (1-based)' },
    { name: 'defaultPage', type: 'number', moveSpecific: true, description: 'Initial page for uncontrolled mode' },
    { name: 'onChange', type: '(page: number) => void', moveSpecific: true, description: 'Called when active page changes' },
  ...
  tokens: [
    { name: '--move-pagination-item-bg', value: 'transparent', description: 'Item default background' },
    { name: '--move-pagination-item-bg-hover', value: 'var(--move-bg-muted)', description: 'Item hover background' },
    { name: '--move-pagination-item-bg-active', value: 'var(--move-primary)', description: 'Active item/indicator background' },
    { name: '--move-pagination-item-fg', value: 'var(--move-fg-muted)', description: 'Item default text color' },
    { name: '--move-pagination-item-fg-hover', value: 'var(--move-fg-base)', description: 'Item hover text color' },
    { name: '--move-pagination-item-fg-active', value: 'var(--move-primary-fg)', description: 'Active item text color' },
    { name: '--move-pagination-item-border', value: 'var(--move-border-base)', description: 'Item border color' },
    { name: '--move-pagination-item-radius', value: 'var(--move-rounded-md)', description: 'Item border radius' },
    { name: '--move-pagination-gap', value: 'var(--move-spacing-xs)', description: 'Gap between pagination elements' },
  ],
  ...
  renderContracts: [
    ...
    { id: 'prev-default-icon', description: 'PrevTrigger defaults to a left chevron SVG when no children provided' },
    { id: 'next-default-icon', description: 'NextTrigger defaults to a right chevron SVG when no children provided' },
