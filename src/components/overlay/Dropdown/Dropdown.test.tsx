...
function renderDropdown(
  ...
  return render(
    ui ?? (
      <Dropdown.Root open={open} animate={false}>
        <Dropdown.Trigger>
...
describe('Dropdown', () => {
  ...
  describe('Root', () => {
    ...
    it('supports controlled open state', async () => {
      renderDropdown(
        <Dropdown.Root open={true} animate={false}>
          <Dropdown.Trigger>
            <button>Open</button>
          </Dropdown.Trigger>
          <Dropdown.Portal>
    ...
    it('supports uncontrolled open state with defaultOpen', async () => {
      renderDropdown(
        <Dropdown.Root defaultOpen animate={false}>
          <Dropdown.Trigger>
            <button>Open</button>
          </Dropdown.Trigger>
          <Dropdown.Portal>
    ...
    it('calls onOpenChange when opening', async () => {
      ...
      render(
        <Dropdown.Root onOpenChange={onOpenChange} animate={false}>
  ...
  describe('Trigger', () => {
    ...
    it('forwards className and style', () => {
      render(
        <Dropdown.Root open animate={false}>
  ...
  // === Animation ===
  describe('animation', () => {
    it('animate=false disables animations (dropdown still renders)', async () => {
      render(
        <Dropdown.Root open animate={false}>
          <Dropdown.Trigger>
            <button>Open</button>
