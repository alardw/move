  ...
  subComponents: [
    ...
    },
    {
      ...
      props: [
        ...
        { name: 'removeLabel', type: 'string', moveSpecific: true, description: 'Accessible label for remove button' },
      ],
      usesFactory: true,
    ...
    },
    {
      ...
      props: [
        ...
        { name: 'style', type: 'React.CSSProperties', moveSpecific: false, description: 'Inline styles' },
        { name: 'children', type: 'React.ReactNode', moveSpecific: false, description: 'Custom icon content' },
        { name: 'clearLabel', type: 'string', default: "'Clear all'", moveSpecific: true, description: 'Accessible label for clear button' },
      ],
      usesFactory: true,
