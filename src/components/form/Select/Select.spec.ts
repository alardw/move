...
export const spec = {
  ...
  subComponents: [
    ...
    },
    {
      ...
      description: 'Button trigger wrapping Radix DropdownMenu.Trigger with size/variant/invalid data attributes',
    },
    {
      name: 'Value',
    ...
    },
    {
      ...
      usesFactory: false,
      description: 'Portals content to document body via Radix DropdownMenu.Portal',
    },
    {
      name: 'Content',
      slots: [
      ...
      props: [
        ...
        { name: 'onPointerDownOutside', type: '(e: Event) => void', moveSpecific: false, description: 'Pointer down outside handler' },
        { name: 'onEscapeKeyDown', type: '(e: KeyboardEvent) => void', moveSpecific: false, description: 'Escape key handler' },
        { name: 'onInteractOutside', type: '(e: Event) => void', moveSpecific: false, description: 'Interact outside handler' },
      ],
      usesFactory: true,
      radixPrimitive: 'DropdownMenu.Content',
      description: 'Animated popup content with height animation, stagger enter, and scroll-to-selected on open',
    },
    {
      name: 'Viewport',
    ...
    },
    {
      ...
      description: 'Selectable item with spring hover animation, selected highlight, and label registration',
    },
    {
      name: 'Group',
  ...
  tokens: [
    ...
    { name: '--move-select-trigger-min-width', value: '8rem', description: 'Trigger minimum width' },
    // Content tokens
    ...
    { name: '--move-select-content-min-width', value: '10rem', description: 'Content minimum width' },
    // Item tokens
